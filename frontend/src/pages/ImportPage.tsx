...
export function ImportPage() {
  ...
  return <section className="mx-auto max-w-3xl">
    <div className="mb-10 max-w-2xl">
      <p className="mb-3 text-sm font-semibold uppercase tracking-[0.18em] text-teal-700">Knowledge intake</p>
    ...
    <div className="mt-8 rounded-xl border border-slate-200 bg-white p-5"><p className="font-semibold text-slate-900">Build Week MVP limits</p><ul className="mt-3 grid gap-2 text-sm text-slate-600 sm:grid-cols-2"><li>Up to 10 supported documents</li><li>Maximum archive size: 10 MB</li><li>PDF, DOCX, Markdown, and TXT</li><li>PDFs up to 50 pages</li></ul></div>
  </section>
}
